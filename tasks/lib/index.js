...
var createAndUploadArtifacts = function (options, done) {
    ...
    var upload = function (fileLocation, targetFile) {
        var uploadArtifact = function (cb) {
            ...
            if (options.auth) {
				...
				// Windows version of curl does not like the quotes around the authentication string. 
				// Therefore, place it without quotes on Windows hosts.
	...
	// Disabled as these files do not comply to the Maven specs and are therefore not allowed since Nexus 3.16.0+
